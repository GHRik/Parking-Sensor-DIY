...
class TM1637:
	...
	def ShowDoublepoint(self, on, where): # shows or hides the doublepoint
            self.__whereSetPoint = where
	...
	def coding(self, data, sequenceData):
		...
		if(data == 0x7F):
			data = 0
                        ...
                        data = HexDigits[data]
		if sequenceData == self.__whereSetPoint:
                        data = data + pointData
		return data
	# end coding
